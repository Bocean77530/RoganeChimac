    ...
    >
      <div className="flex-1 p-4 md:p-5 min-w-0">
        <div className="flex items-start gap-2 flex-wrap">
          {item.popular && (
            <span className="rounded-full bg-primary/10 text-primary px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide">Popular</span>
          )}
          {item.chefsPick && (
            <span className="rounded-full bg-yellow/20 text-yellow px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide">Chef's pick</span>
          )}
          {item.soldOut && (
            <span className="rounded-full bg-muted text-muted-foreground px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide">Sold out</span>
          )}
        </div>
